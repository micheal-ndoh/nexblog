      ...
      <div className="flex flex-wrap justify-between items-center gap-4 mb-8">
        ...
        <div className="relative flex gap-2">
          <button
            ...
            className="bg-gray-800 text-gray-300 rounded-lg px-4 py-2 text-sm font-medium hover:bg-gray-700 transition-colors"
          >
            Mark all as read
          </button>
          <button
      ...
      {loading ? (
        <div className="space-y-4">
          {[...Array(5)].map((_, i) => (
            <div
              key={i}
              className="glassmorphism-card rounded-lg p-4 animate-pulse"
            >
            ...
            <div className="divide-y divide-gray-700">
              {notifications.map((notification) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`flex items-start gap-4 p-4 hover:bg-gray-800/50 transition-colors ${
                    ...
                    >
                      ...
                      {!notification.read && (
                        <div className="h-3 w-3 rounded-full bg-orange-500 flex-shrink-0 mt-1" />
                      )}
                    </div>
                  </Link>
                );
