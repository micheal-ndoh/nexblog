...
export default function HomePage() {
  return (
    <div className="min-h-screen gradient-bg">
      {/* Hero Section */}
      <section className="text-center mb-6 sm:mb-8 lg:mb-16 pt-2 sm:pt-4 lg:pt-8 px-4">
        ...
        <p className="text-gray-300 mb-4 sm:mb-6 lg:mb-8 max-w-2xl mx-auto text-sm sm:text-base lg:text-lg px-4 leading-relaxed">
      ...
      <section className="mb-6 sm:mb-8 lg:mb-16">
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-4 sm:mb-6 lg:mb-8 px-4">
